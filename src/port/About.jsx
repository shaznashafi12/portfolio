  ...
  return (
    <div id='about'>
      ...
      >
        ...
        <h6 className="text-lg sm:text-xl text-center mt-6 text-gray-300 tracking-wide leading-relaxed">
          Learn more about who I am, what I do, <br className="hidden sm:block" />
        ...
        >
          ...
          <div className="w-full lg:w-1/2 lg:pr-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-200 mb-8 tracking-wider">
              Get to know me!
            </h2>
          ...
          {/* Right Section */}
          <div className="w-full lg:w-1/2 lg:pl-12 mt-14 lg:mt-0">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-200 mb-8 tracking-wider">
              My Skills
            </h2>
