...
>
  <h1 className="font-sans text-4xl font-bold text-center">ABOUT ME</h1>
  <div className="mx-auto w-8 pt-3 border-b-4 border-purple-500"></div>
  <h6 className="text-xl text-black text-center mt-6 font-normal text-stone-600">
  ...
  <div className="flex justify-between px-[150px] pt-[100px]">
    <div className="w-1/2">
      <h1 className="font-bold text-3xl mb-7">Get to know me!</h1>
      ...
      <p className="text-stone-500 text-lg mb-5">
      ...
      <Link to="">
        <button className="w-56 h-14 rounded-lg font-bold bg-violet-500 text-white hover:bg-violet-600">
          CONTACT
        </button>
      </Link>
    </div>
    ...
    <div className="w-1/2 pl-16">
      <h1 className="font-bold text-3xl mb-6 ml-16 mb-7">My Skills</h1>
      <button className='w-20 h-10 rounded-lg font-bold bg-gray-200 text-stone-500 ml-16'>HTML </button>
          ...
          <button className='w-20 h-10 rounded-lg font-bold bg-gray-200 text-stone-500 ml-4'>React </button>
          <button className='w-32 h-10 rounded-lg font-bold bg-gray-200 text-stone-500 ml-16 mt-6'>Bootstrap </button>
          <button className='w-32 h-10 rounded-lg font-bold bg-gray-200 text-stone-500 ml-4 mt-6'>Tailwind </button>
          <button className='w-20 h-10 rounded-lg font-bold bg-gray-200 text-stone-500 ml-4 mt-6'>PHP </button>
          <button className='w-20 h-10 rounded-lg font-bold bg-gray-200 text-stone-500 ml-4 mt-6'>Github </button>
