  ...
  >
    {menuOpen ? (
      ...
      <FiMenu className="text-2xl text-white" />
        ...
        {/* Mobile Navigation (NOT TRANSPARENT OVER HERO) */}
        {menuOpen && (
      ...
      >
        ...
        <div className="absolute top-20 left-32 w-60 h-60 bg-[#9b87ff]/20 rounded-full blur-[90px] hidden sm:block"></div>
        <div className="absolute bottom-20 right-32 w-72 h-72 bg-[#5f6fff]/20 rounded-full blur-[100px] hidden sm:block"></div>
        ...
        <div className="relative z-10 flex flex-col items-center px-6 max-w-4xl mx-auto">
          <h1 className="text-5xl font-semibold tracking-tight leading-tight font-serif
            ...
            drop-shadow-[0_4px_25px_rgba(0,0,0,0.4)]">
        ...
        <div className="hidden lg:flex absolute right-16 top-1/3 flex flex-col items-center gap-8">
          ...
          {[FaLinkedin, IoLogoGithub].map((Icon, i) => (
            <Icon key={i} className="h-6 w-6 text-white/70 hover:text-white cursor-pointer" />
          ))}
